<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 步骤条 -->
      <!-- space,每个step的间距，不填写将自适应间距,支持百分比。 -->
      ...
      <el-form
        ...
        label-position="top"
      >
        <!-- v-model(string),绑定值，选中选项卡的name -->
        <!-- tab-position,选项卡所在位置 -->
        <!-- before-leave,切换标签之前的钩子,若返回false或者返回Promise且被reject,则阻止切换。 -->
        <el-tabs
          v-model="activeIndex"
          :tab-position="'left'"
        ...
        >
          ...
          <!-- name,与选项卡绑定值value对应的标识符，表示选项卡别名 -->
